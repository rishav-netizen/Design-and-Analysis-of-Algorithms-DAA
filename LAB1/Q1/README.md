...
| File | Description |
|------|-------------|
| 📄 [main.c](./main.c) | Generates function values and prints the theoretical ordering |
| 🐍 [main.py](./main.py) | Reads the CSV file and generates the graph |
| 📊 [q1_data.csv](./q1_data.csv) | Experimental data generated by the C program |
| 🖼️ [growth_comparison.png](./growth_comparison.png) | Performance comparison graph |
...
<p align="center">
  <a href="./growth_comparison.png">
    <img src="./growth_comparison.png" alt="Growth Comparison Graph" width="900">
  </a>
</p>
...
| File | Description |
|------|-------------|
| 📊 [q1_data.csv](./q1_data.csv) | Generated values of all functions for n = 1…200 |
| 🖼️ [growth_comparison.png](./growth_comparison.png) | Comparison graph of all functions |
...
- 📊 [Experimental Dataset (q1_data.csv)](./q1_data.csv)
- 🖼️ [Generated Graph (growth_comparison.png)](./growth_comparison.png)
